...
insert into test_market.items (product_code, name, description, price, "count", parent_id) values
                                                                                    ('1', 'Миндаль', '500', 500.00, 5, 11),
                                                                                    ('2', 'Грецкий орех', '500', 400.00, 10, 11),
                                                                                    ('3', 'Кедровый орех', '200', 500.00, 2, 11),
                                                                                    ('4', 'Бразильский орех', '500', 800.00, 2, 11),
                                                                                    ('5', 'Изюм белый', '700', 250.00, 2, 12),
                                                                                    ('6', 'Изюм чёрный', '700', 250.00, 2, 12),
                                                                                    ('7', 'Изюм корич', '700', 200.00, 2, 12),
                                                                                    ('8', 'Финики', '500', 250.00, 2, 12),
                                                                                    ('9', 'Курага', '500', 300.00, 2, 12),
                                                                                    ('10', 'Чернослив', '500', 150.00, 2, 12),
